...
class PG_checkout 
{
	...
	// Mã merchante site 
	private $merchant_site_code = 'u190';	// Biến này được SohaPay cung cấp cho merchant site
	
	// Mật khẩu bảo mật
	private $secure_secret= '9f22a38775da18e73583'; // Biến này được SohaPay cung cấp cho merchant site
