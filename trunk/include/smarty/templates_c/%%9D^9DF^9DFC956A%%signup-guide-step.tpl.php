<?php /* Smarty version 2.6.26, created on 2011-12-05 23:50:33
         compiled from signup-guide-step.tpl */ ?>
<?php echo '
<style type="text/css">
.block_step {
...
<div class="block_step">
	<div id="step_element_<?php if ($this->_tpl_vars['step'] == 1): ?>on<?php else: ?>off<?php endif; ?>" title="Bước 1: Nhập thông tin tài khoản">
		<div class="step_left" <?php if ($this->_tpl_vars['step'] == 1): ?>style="margin:0"<?php endif; ?>>1</div>
		<div class="step_center">Nhập thông tin tài khoản</div>
		<div class="step_right"></div>
		<div style="clear:both"></div>
	</div>
	
	<div id="step_element_<?php if ($this->_tpl_vars['step'] == 2): ?>on<?php else: ?>off<?php endif; ?>" title="Bước 2: Kích hoạt tài khoản">
	...
	<div id="step_element_<?php if ($this->_tpl_vars['step'] == 3): ?>on<?php else: ?>off<?php endif; ?>" title="Bước 3: Hoàn thành">
