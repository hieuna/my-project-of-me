...
$menu = new menu();
$listAll = $menu->getAllChild("categories_multi","cat_id","cat_parent_id",$iCat,$sql . " AND lang_id = " . $_SESSION["lang_id"] . $sqlcategory,"cat_id,cat_name,cat_order,cat_type,cat_parent_id,cat_has_child,cat_picture,cat_active,cat_show,cat_group,admin_id,cat_link","cat_order ASC, cat_name ASC","cat_has_child");
?>
<html>
<head>
