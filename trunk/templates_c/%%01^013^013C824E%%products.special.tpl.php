...
$this->_sections['loops']['loop'] = is_array($_loop=$this->_tpl_vars['lsProductSpecial']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
	...
	<div style="float: left; width: 20%" class="fluid asin s9a0">
		<div class="inner">
			<div style="position: relative" class="s9hl">
				<a title="<?php echo $this->_tpl_vars['lsProductSpecial'][$this->_sections['loops']['index']]['name']; ?>
" class="title ntTitle noLinkDecoration" href="<?php echo $this->_tpl_vars['lsProductSpecial'][$this->_sections['loops']['index']]['link']; ?>
">
					<div class="imageContainer">
						<img width="135" height="94" alt="<?php echo $this->_tpl_vars['lsProductSpecial'][$this->_sections['loops']['index']]['name']; ?>
" src="<?php echo $this->_tpl_vars['lsProductSpecial'][$this->_sections['loops']['index']]['image1']; ?>
">
					</div>
					<?php echo $this->_tpl_vars['lsProductSpecial'][$this->_sections['loops']['index']]['name']; ?>

				</a>
				<br clear="none">
				<span class="newListprice gry t11"><?php echo ((is_array($_tmp=$this->_tpl_vars['lsProductSpecial'][$this->_sections['loops']['index']]['price_ny'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp));  echo $this->_tpl_vars['menh_gia']; ?>
</span>
				<span class="red t14"><?php echo ((is_array($_tmp=$this->_tpl_vars['lsProductSpecial'][$this->_sections['loops']['index']]['price'])) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp));  echo $this->_tpl_vars['menh_gia']; ?>
</span>
			</div>
		</div>
	</div>
