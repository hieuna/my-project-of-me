<?php /* Smarty version 2.6.10, created on 2012-03-16 11:35:01
         compiled from D:/AppServ/www/projects/templates/shopping/topup.tpl */ ?>
<div style="position: absolute; z-index:100; display: block;" id="popupContact">		
	<a href="topup.php" target="_blank" id="closeWidth">
		<img src="<?php echo $this->_tpl_vars['topup']->banner_topup; ?>
" width="650" border="0" />
	</a>
	<br>
	<div>
