<?php /* Smarty version 2.6.10, created on 2012-01-10 11:37:35
         compiled from D:%5CAppServ%5Cwww%5Cmobimart/templates/administrator/newsmid.list.tpl */ ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 if ((1 & ($this->_sections['i']['index'] / 1))): ?>
            <tr  class="stlContent">
              <td align="center">
			  <input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_id']; ?>
"></td>
              <td><a href="newsmid.edit.php?newMid_id=<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_id']; ?>
" class="mainLink"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_title']; ?>
</a></td> 			  
			  <td align="center" class="txt_normal"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_sums']; ?>
</td>              <td align="center" class="txt_normal"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_date']; ?>
</td>
			  <td align="center" class="txt_normal"><?php if (( $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_status'] == 1 )): ?>
			  Hiển thị
				<?php else: ?>
			  Khóa			
			  <?php endif; ?></td>              <td align="center"class="txt_normal"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_order']; ?>
</td>
			  <td align="center" class="txt_normal"><img src="../<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_img']; ?>
" height="70" width="70" border="0"></td>
              </tr>
			<?php else: ?>
              <tr bgcolor="#F5F5F5"  >
              <td align="center"><input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_id']; ?>
"></td>
              <td><a href="newsmid.edit.php?newMid_id=<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_id']; ?>
" class="mainLink"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_title']; ?>
</a></td>  
			  ...
			  <?php if (( $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_status'] == 1 )): ?>
			  Hiển thị
				<?php else: ?>
			  Khóa			
			  <?php endif; ?>
			  
			  </td><td align="center"class="txt_normal"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_order']; ?>
</td>
			  <td align="center" class="txt_normal"><img src="../<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['newMid_img']; ?>
" height="70" width="70" border="0"></td>
              </tr> 
