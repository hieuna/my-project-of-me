<?php /* Smarty version 2.6.10, created on 2012-01-10 11:32:20
         compiled from D:%5CAppServ%5Cwww%5Cmobimart/templates/administrator/menulevel2.list.tpl */ ?>
	  ...
	  <!--- MAIN -->
	   <td>
	    <table cellpadding="2" cellspacing="0" align="center" border="0" style="border-collapse:collapse " width="540">
		 <tr>
		  <td colspan="2" background="images/nav_03.gif" class="stlTitle" height="26"><img src="../images/button/browser.png" width="48" height="48" vspace="5" align="absmiddle">DANH SÁCH CÁC SUB MENU <img src="../images/button/leftBgnd.jpg" width="600" height="1"></td>
		 </tr>
		 <tr><td colspan="2"><img src="images/spacer.gif" height="4" border="0" width="100%"></td></tr>
		 <tr valign="middle">
        <td height="30"><a href="menulevel2.add.php?page=0" class="mainLink">Thêm mới</a> | <a href="javascript: Delete();" class="mainLink">Xóa</a> |<a href="#" class="mainLink" onClick="window.history.back()"> Quay lại</a> </td>
      ...
      <tr>
        <td colspan="2"><form action="" method="post" name="frmList" id="frmList">
          <table width="100%"  border="0" align="center" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC" style="BORDER-COLLAPSE: collapse">
            <tr background="../images/button/itable.jpg" class="stlTitle" >
              ...
              <td height="25" class="stlTitle" background="../images/button/itable.jpg">Tên Menu Con 
                <input name="str_id" type="hidden" id="str_id"> 
                </td> 
			  <td height="25" align="center" background="../images/button/itable.jpg">
			  Tên menu cha
			  </td>            
              <td height="25" align="center" background="../images/button/itable.jpg">Thứ tự của menu con</td>
              </tr>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 if ((1 & ($this->_sections['i']['index'] / 1))): ?>
            <tr  class="stlContent">
              <td align="center">
			  <input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['submn_id']; ?>
"></td>
              <td><a href="menulevel2.edit.php?submn_id=<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['submn_id']; ?>
" class="mainLink"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['submn_name']; ?>
</a></td> 
			  <td align="center" class="txt_normal"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['mn_name']; ?>
</td>           
              <td align="center"class="txt_normal"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['submn_order']; ?>
</td>
              </tr>
			<?php else: ?>
              <tr bgcolor="#F5F5F5"  >
              <td align="center"><input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['submn_id']; ?>
"></td>
              <td><a href="menulevel2.edit.php?submn_id=<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['submn_id']; ?>
" class="mainLink"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['submn_name']; ?>
</a></td>  
            ...
            <tr>
              <td colspan="4" align="center" class="txtuserpass">Chưa thêm một menu cấp con nào ...</td>
              </tr>
			<?php endif; ?>
            <tr align="center" >
