<?php /* Smarty version 2.6.10, created on 2012-01-10 11:35:53
         compiled from D:%5CAppServ%5Cwww%5Cmobimart/templates/administrator/represent.list.tpl */ ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 if ((1 & ($this->_sections['i']['index'] / 1))): ?>
            <tr  class="stlContent">
              <td align="center">
			  <input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_id']; ?>
"></td>
              <td><a href="represent.edit.php?re_id=<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_id']; ?>
" class="mainLink"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_sum']; ?>
</a></td> 		  
			                
			  <td align="center" class="txt_normal"><?php if (( $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_status'] == 1 )): ?>
			  Hiển thị
				<?php else: ?>
			  Khóa			
			  <?php endif; ?></td>        
			...
			<?php else: ?>
              <tr bgcolor="#F5F5F5"  >
              <td align="center"><input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_id']; ?>
"></td>
              <td><a href="represent.edit.php?re_id=<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_id']; ?>
" class="mainLink"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_sum']; ?>
</a></td>  
			  ...
			  <?php if (( $this->_tpl_vars['r'][$this->_sections['i']['index']]['re_status'] == 1 )): ?>
			  Hiển thị
				<?php else: ?>
			  Khóa			
			  <?php endif; ?>			 
