<?php /* Smarty version 2.6.10, created on 2012-01-09 16:05:16
         compiled from D:%5CAppServ%5Cwww%5Cmobimart/templates/administrator/menulevel1.list.tpl */ ?>
...
$this->_sections['i']['last']       = ($this->_sections['i']['iteration'] == $this->_sections['i']['total']);
 if ((1 & ($this->_sections['i']['index'] / 1))): ?>
            <tr>
              <td align="center" class="txt_normal"><input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['mn_id']; ?>
"></td>
              <td><a href="menulevel1.edit.php?mn_id=<?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['mn_id']; ?>
" class="mainLink"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['mn_name']; ?>
</a></td>            
              <td align="center" class="txt_normal"><?php echo $this->_tpl_vars['r'][$this->_sections['i']['index']]['mn_order']; ?>
</td>
              </tr>
			<?php else: ?>
              <tr bgcolor="#F5F5F5">
