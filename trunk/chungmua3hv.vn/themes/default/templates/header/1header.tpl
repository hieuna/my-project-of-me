<div id="pageHeader">
            ...
            {if $cate}
             ...
             {/if}
                ...
                {foreach from=$category item=item}
                    <li><a href="{$item.Group_Mark}.html">{$item.Group_Name}</a></li>
				{/foreach}
                </ul>   
            </div> 
        </div>
    ...
    <div class="topMenu">
   		...
   		<ul>
            {foreach from=$category item=item}
                <li><a href="{$item.Group_Mark}.html" {if $smarty.get.DID==$item.Group_Mark} class="selected"{/if}>{$item.Group_Name}</a></li>
            {/foreach}
        </ul>
        </div>
   </div>