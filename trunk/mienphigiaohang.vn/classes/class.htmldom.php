...
function curl_get_html( $url, $lowercase=true )
{
...
class parse_rule{
    public $index_tag_select = "";
    public $attr_tag_select  = "";
    public $rule_full        = "";
    public $currency         = "";
    ...
    function parse_rule($string){
        ...
        if(strpos($string, "|") === false){
            $this->rule_full = $string;
            $this->index_tag_select = "";
            $this->attr_tag_select = "";
            $this->currency = "";
            return;
        }
        else{
    ...
    */
    function parse($string){
        $array_select = explode('|',$string);
        if(is_array($array_select)){
            $this->rule_full            = isset($array_select[0]) ? $array_select[0] : "";
            $this->index_tag_select     = isset($array_select[1]) ? $array_select[1] : "";
            $this->currency             = isset($array_select[2]) ? $array_select[2] : "";
            $this->attr_tag_select      = isset($array_select[3]) ? $array_select[3] : "";
        }
        return;
    }
}
