<? 
include("lang.php");
//require_once("../modules/products_multi/add.php");
//require_once("../modules/products_multi/add.php");
...
//echo($_SESSION["city"]);
	...
	//echo $rows["pro_name"];
	//echo $rows["pro_meta_keywords"];
	//echo $pro_id;
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        <title><?=$rows["pro_site_title"];?></title>
		<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		<meta name="keywords" content="<?=str_replace("\n","",htmlspecialchars($rows["pro_meta_keywords"]));?>" /> 
		<meta name="description" content="<?=str_replace("\n","",htmlspecialchars($rows["pro_meta_description"]));?>" /> 
...
<body style="background:#8B1A1A;"><!--url(../images/bg1.png) repeat " center fixed"--> 
