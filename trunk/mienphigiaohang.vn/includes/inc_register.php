<?php
include("inc_submit_register.php");
?>
...
<div class="box">
<div class="title-style2"><strong>Đăng ký tài khoản mienphigiaohang.vn</strong></div>
						...
						<div class="col-style1">
							...
							<ul class="form-style">
								<li class="clearfix">
									...
									Bỏ chọn nếu bạn không muốn nhận thông báo deals hàng ngày qua Email
								</li>
								<li class="clearfix">
