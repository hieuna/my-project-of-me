...
class cURL {
    ...
    public function execute() {
        $this->headers[] = 'Host: www.google.com.vn';
        $this->headers[] = 'Accept-Language:vi,en-us;q=0.7,en;q=0.3';
		$this->headers[] = 'Accept-Encoding:gzip,deflate';
		$this->headers[] = 'Accept-Charset:	ISO-8859-1,utf-8;q=0.7,*;q=0.7';
		$this->headers[] = 'Keep-Alive:300';
		//$this->headers[] = 'Connection:keep-alive';
		//$this->headers[] = 'Referer:	http://vietbao.vn/';
        $this->headers[] = 'Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8';
		$this->headers[] = 'Connection: Keep-Alive';
		$this->headers[] = 'Content-type: text/html; charset=utf-8';
		$this->user_agent = 'Mozilla/5.0 (Windows; U; Windows NT 6.1; en-US; rv:1.9.1.9) Gecko/20100315 Firefox/3.5.9 (.NET CLR 3.5.30729)';
        ...
        if(!isset($this->options[CURLOPT_USERAGENT]))         $this->options[CURLOPT_USERAGENT] = $this->user_agent;
        if(!isset($this->options[CURLOPT_REFERER]))           $this->options[CURLOPT_USERAGENT] = 'http://www.google.com.vn';
        //if(!isset($this->options[CURLOPT_REFERER]))           $this->options[CURLOPT_USERAGENT] = 'http://www.google.com';
