...
window.addEvent("domready",function(){
	getUpdates();
	//
	var data_sources = [document.id('jform_params_com_categories'), document.id('jform_params_com_articles'), document.id('jform_params_k2_categories'), document.id('jform_params_k2_articles'), document.id('jform_params_k2_tags'), document.id('jform_params_redshop_categories'), document.id('jform_params_redshop_products'), document.id('jform_params_vm_categories'),, document.id('jform_params_vm_products') ];
	//
