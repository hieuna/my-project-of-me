...
class PG_checkout 
{
	...
	// Mã merchante site 
	private $merchant_site_code = 'u303848';	// Biến này được SohaPay cung cấp cho merchant site
	
	// Mật khẩu bảo mật
	private $secure_secret= 'd27efa3aef0cf1670e3a'; // Biến này được SohaPay cung cấp cho merchant site
	...
	public function buildEmbedHTML($params=array()){
	    ...
	    return sprintf('<a class="mcpBtn" href="%s" target="_blank"><img src="%simages/btn/muangay_sohapay_orange.png" style="border: none;" /></a>', $url, PG_URL_ROOT);
	}
