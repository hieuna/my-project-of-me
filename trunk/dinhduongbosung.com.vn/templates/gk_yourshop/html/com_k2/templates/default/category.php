    ...
    <div class="itemListSubCategories">
      ...
      <div class="subCategoryContainer<?php echo $lastContainer; ?>"<?php echo (count($this->subCategories)==1) ? '' : ' style="width:'.(number_format(100/$this->params->get('subCatColumns'), 1)-0.1).'%;"'; ?>>
        ...
        <div class="subCategory">
          ...
          <a class="subCategoryImage" href="<?php echo $subCategory->link; ?>"> 	<img alt="<?php echo K2HelperUtilities::cleanHtml($subCategory->name); ?>" src="<?php echo $subCategory->image; ?>" />
          ...
          <h2> <a href="<?php echo $subCategory->link; ?>"> <?php echo $subCategory->name; ?>
            ...
            <span><?php if($this->params->get('subCatTitleItemCounter')) echo ' ('.$subCategory->numOfItems.')'; ?></span>
          ...
          <a class="k2ReadMore" href="<?php echo $subCategory->link; ?>"> <?php echo JText::_('K2_VIEW_ITEMS'); ?> </a>
