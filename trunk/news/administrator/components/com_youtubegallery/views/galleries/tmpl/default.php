...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort',   'Gallery Name', 'galleryname', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
			<th class="title">
				Last Update
			</th>
	...
	foreach ($rows as $row)
	{
		...
		$link_edittable='index.php?option=com_youtubegallery&controller=galleries&task=edit&cid[]='.$row->id;
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td nowrap="nowrap">
				...
				<?php echo JText::sprintf(JText::_('Last update: %s, update period: <i>every %s days(s)</i>'),$row->lastplaylistupdate,$row->updateperiod); ?>
			</td>
