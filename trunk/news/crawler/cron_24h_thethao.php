...
$aLink = array(
	//24H.COM.VN
	array('sectionid' => 7, 'catid' =>60 , 'link'=> 'http://hn.24h.com.vn/bong-da-duc-c152.html', 'url' => $domain) //Sức khỏe giới tính
);
...
foreach ($aLink as $array) {
	...
	foreach ($html->find('.boxDonItem') as $index => $items) {
		...
		foreach ($articles as $index => $article) {
			...
			$fulltext	= preg_replace('<div align="center"><br /> //</div>', '', $fulltext);
