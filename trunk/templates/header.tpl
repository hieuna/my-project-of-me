...
<html>
	<head>
        ...
        <title>XTech.vn{$page_title}</title>
    </head>
    <body style="background: url('{$bg}') no-repeat center center fixed;">
    	<div id="header" class="clearfix">
    		<div id="top_header">
    			<div class="main_top_header clearfix">
    				<div class="logo">
    					<a href="{$http_root}"><img src="images/logo.png" width="87" height="34" /></a>
    				</div>
    		...
    		<div id="bottom_header">
    			<div class="main_bottom_header clearfix">
    				...
    				<div class="menu">
	    				<ul>
	    					<li class="phone"><a href="{$http_root}dienthoaididong">Điện thoại</a></li>
	    					<li class="tablet"><a href="{$http_root}tablet">Máy tính bảng</a></li>
	    					<li class="laptop"><a href="{$http_root}laptop">Máy tính</a></li>
	    					<li class="thietbiso"><a href="{$http_root}camera">Thiết bị số</a></li>
	    					<li class="phukien"><a href="{$http_root}phukien">Phụ kiện</a></li>
	    				</ul>
	    			</div>
    			</div>
    		</div>
