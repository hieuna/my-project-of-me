<div class="mainbox2-container">
	...
	<div class="mainbox2-body">
		...
		<tr>
					...
					<table border="0" cellpadding="3" cellspacing="3" width="100%">
						<tr valign="top">
							<td class="center product-image" width="2%">
								<a href="{$lsProductDiscount[loops].link}">
								<img class=" " id="{$lsProductDiscount[loops].name}" src="{$lsProductDiscount[loops].image1}" width="40" height="40" alt="{$lsProductDiscount[loops].name}"  border="0" />
								</a>
							</td>
							<td width="30%" class="compact">
								<a href="{$lsProductDiscount[loops].link}" class="product-title" title="{$lsProductDiscount[loops].name}">{$lsProductDiscount[loops].name}</a>	
								<p>							
									<span class="cm-reload-180001153 price-update" id="price_update_180001153">
										...
										<span class="price" id="line_discounted_price_180001153">
											<span id="sec_discounted_price_180001153" class="price">{$lsProductDiscount[loops].price|number_format}</span>
			...
			{if $lsProductDiscount[loops].stt%3 ==0}
			</tr><tr>
			{else}
			<td width="2%">&nbsp;</td>
			{/if}
