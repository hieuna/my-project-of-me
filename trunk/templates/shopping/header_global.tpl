...
<link href="css/{$name_template}/styles.css" rel="stylesheet" type="text/css" />
<link href="css/{$name_template}/print.css" rel="stylesheet" media="print" type="text/css" />
<link href="css/{$name_template}/dropdown.css" rel="stylesheet" type="text/css" />
<!--[if lte IE 7]>
<link href="css/{$name_template}/styles_ie.css" rel="stylesheet" type="text/css" />
<![endif]-->
