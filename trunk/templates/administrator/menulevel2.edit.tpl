	...
	<td width="520">
	 <table cellspacing=0 cellpadding=3 width="520" border=0 align="center">
	  ...
	  <tr>
	   ...
	   <tr>
	     <td class="textsearchjob" align="left" colspan="2"><span class="stlTitle"><img src="../images/button/impressions.png" width="48" height="48" vspace="5" align="absmiddle">CẬP NHẬT THÔNG TIN SUBMENU <img src="../images/button/impressions.png" width="600" height="1"></span></td>
	     </tr>
	   <tr>
	   ...
	   <tr>
	    ...
	    <td>
			<select name="mn_id">			
		<option value="{$RowMenuLevel2Update[0].mn_id}">{$RowMenuLevel2Update[0].mn_name}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
	   ...
	   <tr>
	    ...
	    <td>
		 <input type="text" name="submn_name" id="submn_name" class="textbox" style="width:150px "  value="{$RowMenuLevel2Update[0].submn_name}">		</td>		
	   </tr>
	   <tr>
	    <td width="30%" class="stlTitle">Thứ tự của menu <font color="#FF0000">(*)</font> </td>
	    <td>
		 <input type="text" name="submn_order" id="submn_order" class="textbox" style="width:150px " value="{$RowMenuLevel2Update[0].submn_order}">		</td>		
	   </tr>	   
	   <tr>
	    <td class="textadv">&nbsp;</td>
		...
		<input type="hidden" name="updateMenuLevel2" value="updateMenuLevel2" id="updateMenuLevel2"></td>
	   </tr>	  
    </table>
	   </form>		
	   </td>	  
