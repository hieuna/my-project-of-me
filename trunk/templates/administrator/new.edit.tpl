	 ...
	 <script language="javascript">	  
	  ...
	  function getSubMenu(){
	  	with(document.frmReg){
			window.location = "new.add.php?mn_id=" + mn_id.value ;			
		}		
	  }	  	  
	 </script>	 
	{/literal}
...
<body leftmargin=0 topmargin=0 marginheight="0" marginwidth="0" bgcolor="#ffffff" onLoad="javascript:document.frmReg.news_status.value={$status};document.frmReg.news_hot.value={$hot}">
	...
	<td width="520">
	 <table cellspacing=0 cellpadding=3 width="520" border=0 align="center">
	  ...
	  <tr>
	   ...
	   <tr>
	     <td class="textsearchjob" align="left" colspan="2"><span class="stlTitle"><img src="../images/button/impressions.png" width="48" height="48" vspace="5" align="absmiddle">CẬP NHẬT THÔNG TIN TIN TỨC <img src="../images/button/impressions.png" width="600" height="1"></span></td>
	     </tr>
	   <tr>
		...
		<tr>
				<td width="30%" class="stlTitle">Loại tin </td>
				<td>
				<select name="submn_id" id="submn_id" disabled="disabled">				
				
				<option>{$tenloai}</option>
	   ...
	   <tr>
	    ...
	    <td>
			<input name="news_title" type="text" class="textbox" id="news_title" style="width:250px" size="70"  value="{$RowNew[0].news_title}">		
		 </td>		
	   </tr>
	   <tr>
	    ...
	    <td>
			...
			<textarea name="news_sums" id="news_sums" style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid;  FONT-SIZE: 13px; BORDER-LEFT: #000000 1px solid; WIDTH: 300px; BORDER-BOTTOM: #000000 1px solid" rows="3" cols="20">{$RowNew[0].news_sums}</textarea>
	   ...
	   <tr>
	    ...
	    <td>
			<img src="../{$RowNew[0].news_img}" alt="{$RowNew[0].news_img}" width="100" border="0">
		</td>		
	   </tr>
	   <tr>
	   ...
	   <tr>
	    <td width="30%" class="stlTitle">Tình tr&#7841;ng   </td>
	   ...
	   <tr>
	    <td width="30%" class="stlTitle"> Tin nóng   </td>
	   ...
	   <tr>
		...
		<input type="hidden" name="updatenew" value="updatenew" id="updatenew"></td>
	   </tr>	  
    </table>
	   </form>		
