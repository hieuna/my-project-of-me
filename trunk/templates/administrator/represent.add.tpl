	 ...
	 <table cellspacing=0 cellpadding=3 width="520" border=0 align="center">
	  ...
	  <tr>
	   ...
	   <tr>
	    ...
	    <td>
			<textarea name="re_sum" id="re_sum" style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid;  FONT-SIZE: 13px; BORDER-LEFT: #000000 1px solid; WIDTH: 300px; BORDER-BOTTOM: #000000 1px solid" rows="3" cols="20"></textarea>
		</td>		
	   </tr>
	   <tr>
