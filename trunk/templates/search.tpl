...
<table width="780" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="590" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <!--DWLayoutTable-->
      <tr>
        <td width="99%" height="564" valign="top">
			<table width="590" height="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#990099">
				...
				<tr>
					<td valign="top" width="590">
						...
						<tr>
						<td colspan="2"> {section name=i loop=$rc}						</td>
						</tr>
						
							<tr>
								
								<td colspan="2"><a href="newsdetails.php?news_cat={$rf[i].news_cat}&news_id={$rf[i].news_id}" class="style_detail_text_link"> {$rf[i].news_title}</a></td>
							</tr>
							<tr>
								
								<td width="30%" valign="top">
								<a href="newsdetails.php?news_cat={$rc[i].news_cat}&news_id={$rc[i].news_id}">
								<img src="{$rf[i].news_img}" border="0" width="130" height="70">								</a>								</td>
								<td align="left" valign="top" class="style_detail_text_link">{$rf[i].news_sums|truncate:150}</td>
							</tr>
							<tr align="center">
								<td colspan="3">
