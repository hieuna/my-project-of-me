				...
				<tr>
					<td valign="top" width="590">
						<table border="0" cellpadding="0" cellspacing="3" width="100%">
							...
							<tr>
								<td width="5"></td>
								<td colspan="2" class="Title">{$rn[0].newMid_title}</td>
							</tr>
							<tr>
								<td width="5"></td>
								<td width="30%" valign="top">								
								<img src="{$rn[0].newMid_img}" border="0" width="150" height="100">								</td>
								<td align="left" valign="top" class="Lead">{$rn[0].newMid_sums}</td>
							</tr>
							<tr>
								<td width="5"></td>
								<td colspan="2" class="Normal">{$rn[0].newMid_details}</td>
							</tr>
							<tr align="center">
								<td colspan="3">
