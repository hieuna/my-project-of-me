...
FCK.SetHTML = function( html, forceWYSIWYG )
{
	...
	sHtml =
		...
		'<head><title></title>' +
		'<link href="../../../../../inlcudes/FCKeditor/editor/_source/internals/' + FCKConfig.EditorAreaCSS + '" rel="stylesheet" type="text/css" />' +
		'<link href="../../../../../inlcudes/FCKeditor/editor/_source/internals/' + FCKConfig.FullBasePath + 'css/fck_internal.css' + '" rel="stylesheet" type="text/css" _fcktemp="true" />' ;
...
FCK.SetHTML = function( html, forceWYSIWYG )
{
	...
	if ( forceWYSIWYG || FCK.EditMode == FCK_EDITMODE_WYSIWYG )
	{
		...
		if ( FCKConfig.FullPage && FCKRegexLib.BodyContents.test( html ) )
		{
			...
			html = html.replace( FCKRegexLib.HeadCloser, '<link href="../../../../../inlcudes/FCKeditor/editor/_source/internals/' + FCKConfig.BasePath + 'css/fck_internal.css' + '" rel="stylesheet" type="text/css" _fcktemp="true" /></head>' ) ;
...
*/
		...
		else
		{
			...
			sHtml =
				...
				'<head><title></title>' +
				'<link href="../../../../../inlcudes/FCKeditor/editor/_source/internals/' + FCKConfig.EditorAreaCSS + '" rel="stylesheet" type="text/css" />' +
				'<link href="../../../../../inlcudes/FCKeditor/editor/_source/internals/' + FCKConfig.BasePath + 'css/fck_internal.css' + '" rel="stylesheet" type="text/css" _fcktemp="true" />' ;
