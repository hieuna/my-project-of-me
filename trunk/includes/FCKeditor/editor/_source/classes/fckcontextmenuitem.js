...
FCKContextMenuItem.prototype.CreateTableRow = function( targetTable )
{
	...
	if ( this.HasIcon ) oCell.innerHTML = '<img alt="" src="../../../../../inlcudes/FCKeditor/editor/_source/classes/' + FCKConfig.SkinPath + 'toolbar/' + this.Command.Name.toLowerCase() + '.gif" width="21" height="20">' ;
...
<tr class="CM_Disabled">
	<td class="CM_Icon"><img alt="" src="../../../../../inlcudes/FCKeditor/editor/_source/classes/icons/cut.gif" width="21" height="20"></td>
