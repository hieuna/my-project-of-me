...
FCKSpecialCombo.prototype.Create = function( targetElement )
{
	...
	else
	{
		...
		oField.innerHTML ='<table title="' + this.Tooltip + '" class="' + sClass + '" cellspacing="0" cellpadding="0" border="0">' +
				'<tr>' +
					//'<td class="TB_Icon"><img src="../../../../../inlcudes/FCKeditor/editor/_source/classes/' + FCKConfig.SkinPath + 'toolbar/' + this.Command.Name.toLowerCase() + '.gif" width="21" height="21"></td>' +
					'<td class="TB_Text">' + this.Caption + '</td>' +
					'<td class="TB_ButtonArrow"><img src="../../../../../inlcudes/FCKeditor/editor/_source/classes/' + FCKConfig.SkinPath + 'images/toolbar.buttonarrow.gif" width="5" height="3"></td>' +
				'</tr>' +
			'</table>' ;
	}
