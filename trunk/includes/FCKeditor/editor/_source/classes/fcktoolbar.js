...
var FCKToolbar = function()
{
	...
	oCell.innerHTML = '<img src="../../../../../inlcudes/FCKeditor/editor/_source/classes/' + FCKConfig.SkinPath + 'images/toolbar.start.gif" width="7" height="21" style="VISIBILITY: hidden" onload="this.style.visibility = \'\';">' ;
...
{
	var oCell = this.DOMRow.insertCell(-1) ;
	oCell.innerHTML = '<img src="../../../../../inlcudes/FCKeditor/editor/_source/classes/' + FCKConfig.SkinPath + 'images/toolbar.separator.gif" width="5" height="21" style="VISIBILITY: hidden" onload="this.style.visibility = \'\';">' ;
}
...
FCKToolbar.prototype.AddTerminator = function()
{
	...
	oCell.innerHTML = '<img src="../../../../../inlcudes/FCKeditor/editor/_source/classes/' + FCKConfig.SkinPath + 'images/toolbar.end.gif" width="12" height="21" style="VISIBILITY: hidden" onload="this.style.visibility = \'\';">' ;
}
