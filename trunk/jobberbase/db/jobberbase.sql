...
CREATE TABLE IF NOT EXISTS `jobber_admin` (
...
INSERT INTO `jobber_admin` (`id`, `username`, `password`) VALUES
...
CREATE TABLE IF NOT EXISTS `jobber_categories` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `jobber_categories` (`id`, `name`, `var_name`, `category_order`) VALUES
...
CREATE TABLE IF NOT EXISTS `jobber_cities` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `jobber_cities` (`id`, `name`, `ascii_name`) VALUES
(1, 'London', 'London'),
...
CREATE TABLE IF NOT EXISTS `jobber_hits` (
...
INSERT INTO `jobber_jobs` (`id`, `type_id`, `category_id`, `title`, `description`, `company`, `city_id`, `url`, `apply`, `created_on`, `is_temp`, `is_active`, `views_count`, `auth`, `outside_location`, `poster_email`, `apply_online`, `spotlight`) VALUES
...
CREATE TABLE IF NOT EXISTS `jobber_job_applications` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `job_id` int(10) unsigned NOT NULL,
  `created_on` datetime NOT NULL,
  `ip` varchar(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `jobber_pages` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `jobber_pages` (`id`, `url`, `page_title`, `keywords`, `description`, `title`, `content`, `has_form`, `form_message`) VALUES
...
CREATE TABLE IF NOT EXISTS `jobber_searches` (
  `id` int(10) unsigned NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `jobber_spam_reports` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE IF NOT EXISTS `jobber_types` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `jobber_types` (`id`, `name`, `var_name`) VALUES
...
CREATE TABLE IF NOT EXISTS `jobber_settings` (
...
INSERT INTO `jobber_settings` (`id`, `category_id`, `name`, `title`, `description`, `data_type`, `input_type`, `input_options`, `validation`, `value`, `ordering`) VALUES
...
CREATE TABLE IF NOT EXISTS `jobber_settings_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `jobber_settings_categories` (`id`, `name`, `var_name`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `jobber_links` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `title` varchar(255) NOT NULL,
...
INSERT INTO `jobber_links` (`id`, `url`, `name`, `title`, `menu`, `link_order`) VALUES
