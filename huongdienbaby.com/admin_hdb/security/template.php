...
function template_top($title='',$help=1){
	include("../login/template/config.php");
	global $module_id;
?>
	...
	<tr>
		<td align="center">
			...
			<? /*---------- Title start here ----------*/ ?>
						...
						<div class="form_title"><a href="../help/detail.php?iMod=<?=$module_id?>&url=<?=base64_encode($_SERVER['SCRIPT_NAME'] . '?' . @$_SERVER['QUERY_STRING'])?>"><img src="../images/help.gif" border="0" align="absmiddle" /> &nbsp; Xem hướng dẫn sử dụng</a></div>
			<? /*---------- Title end here ----------*/ ?>
					</td>
			<?
			}
