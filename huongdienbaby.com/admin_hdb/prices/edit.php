...
require_once("../../classes/generate_form_class.php");
...
//Khai bao Bien
$fs_redirect	= base64_decode(getValue("pri_type","str","GET",base64_encode("listing.php")));
//Call Class generate_form();
$myform = new generate_form();
//Loại bỏ chuc nang thay the Tag Html
$myform->removeHTML(0);
$record_id			= getValue("record_id","int","GET");
$db_edit =new db_query("SELECT * FROM " . $fs_table . " WHERE pri_id=" . $record_id);
...
if($action == "insert"){
	...
	if($errorMsg == ""){
		$db_ex = new db_execute($myform->generate_update_SQL("pri_id", $record_id));
	...
	<tr>
		...
		<form ACTION="<?=$_SERVER['SCRIPT_NAME'] . "?" . @$_SERVER['QUERY_STRING']?>" METHOD="POST" name="add_new" enctype="multipart/form-data">
			<tr>
				...
				<td>
					<textarea name="pri_description" id="pri_description" class="form" cols="50" rows="10"><?=$row["pri_description"];?></textarea>				</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>
