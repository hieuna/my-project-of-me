...
class PG_checkout 
{
	...
	// Mã merchante site 
	private $merchant_site_code = 'u189';	// Biến này được SohaPay cung cấp cho merchant site
	
	// Mật khẩu bảo mật
	private $secure_secret= '12345678'; // Biến này được SohaPay cung cấp cho merchant site
