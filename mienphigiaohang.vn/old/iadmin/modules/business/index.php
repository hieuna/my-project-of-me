...
if($action=='view')
{
	...
	$where="where id='".$id."'";
	$listcontact=listcontact_business($where,$limit);
...
elseif($_REQUEST['action']=='del')
{
	...
	mysql_query("DELETE FROM contact_business where id='".$id."'");
...
else
{
	...
	if($_POST['submit'])
	{
		if($_POST['Selected'])
		{
			...
			{
				mysql_query("DELETE FROM contact_business WHERE id='$udel'");
			}
		}
	}
	...
	$url_page="do=business&id_module=".$id_module.$psearch;
