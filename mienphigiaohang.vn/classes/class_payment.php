...
class PG_checkout 
{
	...
	// Mã merchante site 
	private $merchant_site_code = 'u191';	// Biến này được SohaPay cung cấp cho merchant site
	
	// Mật khẩu bảo mật
	private $secure_secret= '41805889ac7547806e7d'; // Biến này được SohaPay cung cấp cho merchant site
	...
	public function buildEmbedHTML($params=array()){
	    ...
	    return sprintf('<a class="mcpBtn" href="%s"><img src="%simages/btn/thanhtoan_sohapay_blue.png" style="border: none; widht: 128px;" /></a>', $url, PG_URL_ROOT);
	}
