<? 
	...
	checkAddEdit("add");
	$loca_ord  		 =  getValue("loca_ord","int","POST","");	
	$loca_title  		 =  getValue("loca_title","str","POST","");
...
<p align="center" style="padding-left:10px;">
    ...
    <?=$form->text("Mã vùng", "loca_ord", "loca_ord", $loca_ord, "Mã vùng", 1, 250, "", 250, "", "", "")?>    
    <?=$form->text("Tên vùng", "loca_title", "loca_title", $loca_title, "Tên vùng", 1, 250, "", 250, "", "", "")?>
