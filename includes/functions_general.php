...
//Replace ky tu co dau sang ko dau
...
function ReplaceHTML($str){
	$character 	= array('&nbsp;', '&lt;', '&gt;', '&amp;', '&quot;');
    $html		= array(' ', '<', '>', '&', '"');
    return str_replace($character, $html, $str);
}
function createRandString($num=5){
...
//upload NGOCKV FOR JOOMLA 1.0.15
