...
if(isset($_POST['str_id']) && $_POST['str_id']<>'') {
 $hnrid=$_POST['str_id'];
 $ql_del="DELETE FROM ".TBL_REPRESENT." WHERE re_id=".$hnrid;
 $result_del=mysql_query($ql_del) or die("Not Delete.");
}
#--------------------------------------------------------------------------
#VIEW HOUSE TO RENT 
$sql=" SELECT *
       FROM ".TBL_REPRESENT." as A1 ORDER BY A1.re_id ";
...
#--------------------------------------------------------------------------
$smarty->display($template_root.'administrator/represent.list.tpl');
?>
