...
/**
* JElementRedshopGroups - additional element for module XML file
...
class JFormFieldRedshopGroups extends JFormFieldList {
	protected $type = 'redshopGroups'; //the form field type
    var $options = array();
    ...
    protected function getOptions() {
        ...
        $db = JFactory::getDBO();
        // generating query
		$db->setQuery("SELECT sg.shopper_group_name AS name, sg.shopper_group_id AS id, sg.parent_id AS parent FROM #__redshop_shopper_group AS sg ORDER BY sg.shopper_group_name ASC");
 		// getting results
		...
		if(count($results)){
            ...
            array_push($temp_options, array('-1', JText::_('MOD_NEWS_PRO_GK4_ALL_REDSHOP_SHOPPERGROUPS', "0")));
