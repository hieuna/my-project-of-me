...
class GKIS_gk_the_real_design_Controller {
	// configuration array
	private $config;
	// module info
	private $module;
	...
	function getArticleData() {
		...
		// get the data
		if(count($ids) > 0) {
			$this->articles = GKIS_gk_the_real_design_Model::getData($ids);
		}
		if(count($idsK2) > 0) {
			$this->articlesK2 = GKIS_gk_the_real_design_Model::getDataK2($idsK2);
		}
	}
	// generate view
	function generateView() {
		...
		// add script fragment
		$document->addScriptDeclaration('try {$Gavick;}catch(e){$Gavick = {};};$Gavick["gkIs-'.$this->config['module_id'].'"] = { "anim_speed": '.$this->config['config']->gk_the_real_design->gk_the_real_design_animation_speed.', "anim_interval": '.$this->config['config']->gk_the_real_design->gk_the_real_design_animation_interval.', "autoanim": '.$this->config['config']->gk_the_real_design->gk_the_real_design_autoanimation.', "slide_links": '.$this->config['config']->gk_the_real_design->gk_the_real_design_slide_links.', "image_x": '.$this->config['config']->gk_the_real_design->gk_the_real_design_image_x.', "image_y": '.$this->config['config']->gk_the_real_design->gk_the_real_design_image_y.', "text_x": '.$this->config['config']->gk_the_real_design->gk_the_real_design_text_x.', "text_y": '.$this->config['config']->gk_the_real_design->gk_the_real_design_text_y.' };');
