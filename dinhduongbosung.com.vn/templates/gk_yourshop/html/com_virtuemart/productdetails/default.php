...
//var_dump( $this->product->prices); die;
				$price =  $this->product->prices['salesPrice'];
				if ($price == 0){
					echo '<a style="float:left" target="_blank" href="https://sohapay.com/payment_product.php?u=nguyenxuanbach2002@yahoo.com"><img src="https://sohapay.com/images/btn/muangay_sohapay_green.png" style="border: none;"></a>';
				}else{
					$params = array(
						'transaction_info'  => 'Mua sản phẩm '.$this->product->product_name.' tại dinhduongbosung.com.vn',
						'price'             => $price,
						'order_ship'        => 0,
						'order_product_title' => $this->product->product_name, 
						'return_url'		=> 'http://dinhduongbosung.com.vn'
					);
