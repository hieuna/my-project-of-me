  ...
  <div class="boxReport">
 	<div class="frmReport">
        ...
        <div class="contentReport">
            ...
            <p>Xin hãy click <a style=" text-decoration:underline" title="Click vào đây" href="{$smarty.get.url|decode|default:$smarty.const.SITE_URL}">vào đây</a> để về trang chủ</p>
        </div>
    </div>
  </div>
