...
<meta http-equiv="refresh" content="1;url={$smarty.get.url|decode|default:$smarty.const.SITE_URL}">
  ...
  <div class="boxReport">
 	<div class="frmReport">
        ...
        <div class="contentReport">
        	{if $smarty.get.msg}{$smarty.get.msg|decode}{else}Xin vui lòng đợi. Hệ thống sẽ tự động chuyển tới trang chủ...{/if}
            <p>Nếu bạn chờ quá lâu. Xin hãy click <a style=" text-decoration:underline" title="Click vào đây" href="{$smarty.get.url|decode|default:$smarty.const.SITE_URL}">vào đây</a></p>
