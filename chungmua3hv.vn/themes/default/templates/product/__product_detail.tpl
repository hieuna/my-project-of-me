...
countdown(secondsRemaining,'down{/literal}{$product_item.Product_ID}{literal}');
                    ...
                    <div class="pageComment" style="cursor:pointer" title="Xem bình luận" onclick="return gotoTop('CommentID')">Bình luận: <span>{$product_item.comment|default:0}</span></div>
