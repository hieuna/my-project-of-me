<div class="dealBox">
            	<a class="dealTitle"><span>{if $product_item.DestinationID}{$product_item.DestinationID}{else} Toàn quốc {/if}:</span>{$product_item.Product_Name}</a>
                    <div class="clr"></div>
                <div class="dealLeft">
                	<div class="dealPrice">{$product_item.Product_DealPrice|number_format} đ <a  {if $product_item.Product_Sold !=1} href="mua-hang.php?ID={$product_item.Product_ID}"{/if}></a></div>
                    
                    <div style="background-image:url(https://www.baokim.vn/promote/payment_bk_copy.png);width:180px;height:50px;margin-top:-60px;margin-left:7px">	
                    	<div style="margin-left:40px;padding-top:8px">			
                    		<a href="https://www.baokim.vn/payment/customize_payment/product?business=chungmua3hv@gmail.com&product_name={$product_item.Product_Name}&product_price={$product_item.Product_DealPrice}&product_quantity=1&total_amount={$product_item.Product_DealPrice}&affiliate_id=41097017F9DF1F&affiliate_site_id=808" style="font-size:16px;color:#FFF"><b>Mua Trực Tuyến</b><br/>
                            	<div style="font-size:11px;margin-left:40px">Tích lũy : <b>{$product_item.Product_DealPrice/100|number_format}</b> đ</div>
                            </a>
                        </div>    
                    </div>
