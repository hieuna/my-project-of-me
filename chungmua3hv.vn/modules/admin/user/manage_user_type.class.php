...
<script language="javascript">
	...
	{	
		win = window.open("?mod=admin&amod=user&atask=group&task=popup&id="+id+"&ajax=true", "sendtofriend", "location=1,status=1,scrollbars=1,width=700,height=800");
...
class UserTypeBack extends VS_Module_Base{
	...
	function addModule($id)
	{
		...
		$condition = " editable = 1 and showed='1' ";
		$order = "z_index";
