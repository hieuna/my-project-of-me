...
class ContactBack extends baseContact  
{
	...
	function listContact()
	{
		...
		$submit_url= "?mod=admin&amod=contact&atask=contact";
		...
		$oDatagrid->addField(array("field"=> "email","display"=> $this->get_config_vars('create_date'),"datatype"=> "date","sortable"=> true));
