<?php /* Smarty version 2.6.19, created on 2011-09-17 00:43:12
         compiled from follow.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'loadModule', 'follow.tpl', 3, false),)), $this); ?>
...
<div class="all">
    ...
    <div id="pageContent">
    	<div id="pageLeft">
            <!--Phan noi dung-->
            <?php echo smarty_function_loadModule(array('name' => 'follow','task' => $_GET['task']), $this);?>
