...
$GLOBALS['HTML_QUICKFORM_ELEMENT_TYPES'] =
        array(
            ...
            //nhung type moi bo xung them
            'datetime'      =>array('HTML/QuickForm/datetime.php','HTML_QuickForm_datetime'),
            'listcheckbox'      =>array('HTML/QuickForm/listcheckbox.php','HTML_QuickForm_listcheckbox'),
        );
...
$GLOBALS['_HTML_QuickForm_registered_rules'] = array(
    ...
    'weblink'       => array('html_quickform_rule_regex',    'HTML/QuickForm/Rule/Regex.php'),
...
class HTML_QuickForm extends HTML_Common
{
     ...
     * @access    private
     */
    var $_requiredNote = '<span style="font-size:80%; color:#ff0000;">*</span><span style="font-size:80%;">Require data</span>';
    ...
    /**
     * formName for javascript code
     *
     * @var string
     * @access private
     */
    public static $_formName = '';
    ...
    {
    	HTML_QuickForm::$_formName = $formName;
