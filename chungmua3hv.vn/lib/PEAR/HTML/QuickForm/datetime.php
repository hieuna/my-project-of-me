...
class HTML_QuickForm_datetime extends HTML_QuickForm_input
{
    ...
    {
    	echo '<script type="text/javascript" src="lib/calendar/dhtmlgoodies_calendar/dhtmlgoodies_calendar.js?random=20060118"></script>
';
    	echo '<script language = "javascript">var pathToImages = "lib/calendar/images/"; </script>
';
    	echo '<link type="text/css" rel="stylesheet" href="lib/calendar/dhtmlgoodies_calendar/dhtmlgoodies_calendar.css?random=20051112" media="screen"></link>
';
