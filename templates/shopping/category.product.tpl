		...
		<div class="central-column">
			<div class="central-content">
				...
				<div class="mainbox2-container">
					<h1 class="mainbox2-title clear"><span>{$category->name}</span></h1>
					<div class="mainbox2-body">
						<table cellpadding="3" cellspacing="3" border="0" width="100%">
						<tr>
							{section name=loops loop=$lsProduct}
									...
									<table border="0" cellpadding="3" cellspacing="3" width="100%">
										<tr valign="top">
											<td class="center product-image" width="2%">
												<a href="{$lsProduct[loops].link}">
												{if $lsProduct[loops].image1 !=""}
												<img src="{$lsProduct[loops].image1}" width="40" height="40" alt="{$lsProduct[loops].name}"  border="0" />
												{else}
												<img src="image/products/no_image.gif" width="40" height="40" alt="{$lsProduct[loops].name}"  border="0" />
												{/if}
												</a>
											</td>
											<td width="30%" class="compact">
												<a href="{$lsProduct[loops].link}" class="product-title" title="{$lsProduct[loops].name}">{$lsProduct[loops].name}</a>	
												<p>							
													<span class="cm-reload-180001153 price-update" id="price_update_180001153">
														...
														<span class="price" id="line_discounted_price_180001153">
															<span id="sec_discounted_price_180001153" class="price">{$lsProduct[loops].price|number_format}</span>
