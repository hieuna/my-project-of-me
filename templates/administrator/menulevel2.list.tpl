      ...
      <tr>
        <td colspan="2"><form action="" method="post" name="frmList" id="frmList">
          <table width="100%"  border="0" align="center" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC" style="BORDER-COLLAPSE: collapse">
            ...
            <tr  class="stlContent">
              <td align="center">
			  <input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="{$r[i].submn_id}"></td>
              <td><a href="menulevel2.edit.php?submn_id={$r[i].submn_id}" class="mainLink">{$r[i].submn_name}</a></td> 
			  <td align="center" class="txt_normal">{$r[i].mn_name}</td>           
              <td align="center"class="txt_normal">{$r[i].submn_order}</td>
              </tr>
			{else}
              <tr bgcolor="#F5F5F5"  >
              <td align="center"><input name="chkItem" type="checkbox" id="chkItem" onClick="SelectItem(this)" value="{$r[i].submn_id}"></td>
              <td><a href="menulevel2.edit.php?submn_id={$r[i].submn_id}" class="mainLink">{$r[i].submn_name}</a></td>  
			  <td align="center" class="txt_normal" >{$r[i].mn_name}</td>          
              <td align="center" class="txt_normal" >{$r[i].submn_order}</td>
              </tr> 
