...
$all_visitors 	= ($all_visitors+24637)+$yesterday_visitors+$today_visitors;
...
if( $s_week ){
	...
	$week_visitors = $week_visitors*86+236;
}
...
if( $s_lweek ){
	...
	$lweek_visitors = $lweek_visitors*86+236;
}
...
if( $s_month ){
	...
	$month_visitors = $month_visitors*86+236;
}
