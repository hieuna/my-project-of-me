					...
					foreach ( $this->tableau_images as $image )
					{
						...
						{ 
							...
							<?php 
								...
								<div class="img_cont2""><div class="img_thumb2"><a href="#ancre" rel="nofollow" onclick="changer('grande_photo_id','<?php echo $image->url?>'); return false;"><img src="<?php echo $image->vignetteUrl?>"/></a></div></div>
					<?php }
					}
				?>
				<div class="img_clr">
