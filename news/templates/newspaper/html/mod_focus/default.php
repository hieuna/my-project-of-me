...
<div class="box_modules clearfix">
	<div class="title_box_modules">
		<a href="<?php echo JRoute::_( 'index.php?option=com_content&view=category&id=1&group=warehouse&feauture=hot&secid='.$list[0]->sectionid.'&cid='.$list[0]->catid);?>">Tiêu điểm</a>
